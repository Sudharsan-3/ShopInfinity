    ...
    return (
        <div className='p-10'>
            ...
            <div className='flex justify-around p-5 bg-white rounded-2xl'>
                <div className='flex flex-col items-center cursor-pointer bg-trans'>
                    <div>
                ...
                <div className='flex flex-col items-center cursor-pointer  bg-trans'>
                    <div>
                        <img src="https://rukminim2.flixcart.com/flap/80/80/image/29327f40e9c4d26b.png?q=100"  width={65} alt="Fashion" />
                    </div>
                    <span>Fashion</span>
                </div>
                 <div className='flex flex-col items-center cursor-pointer  bg-trans'>
                    <div>
                        <img src="https://rukminim2.flixcart.com/flap/80/80/image/29327f40e9c4d26b.png?q=100"  width={65} alt="Electronics" />
                    </div>
                ...
                <div className='flex flex-col items-center cursor-pointer  bg-trans'>
                    <div>
                        <img src="https://rukminim2.flixcart.com/flap/80/80/image/29327f40e9c4d26b.png?q=100"  width={65} alt="Home & Furniture" />
                    </div>
