...
<button
  onClick={prevSlide}
  className="absolute top-1/2 left-3 z-30 -translate-y-1/2 bg-white/20 backdrop-blur-md hover:bg-white/40 text-white p-3 rounded-full shadow-md transition-all duration-300"
  aria-label="Previous"
>
  <svg
    className="w-5 h-5"
...
<button
  onClick={nextSlide}
  className="absolute top-1/2 right-3 z-30 -translate-y-1/2 bg-white/20 backdrop-blur-md hover:bg-white/40 text-white p-3 rounded-full shadow-md transition-all duration-300"
  aria-label="Next"
>
  <svg
    className="w-5 h-5"
