      ...
      {filterById.length > 0 ? filterById.map((item) => (
        ...
        >
          ...
          <div>
           ...
           <div className='grid sm:grid-cols-1 lg:grid-cols-2 gap-2 mt-2'>
            <div className='flex w-full bg-orange-400 h-15 items-center justify-center gap-3 rounded-md text-white cursor-pointer'>
            <IoCartOutline />
        <h3>ADD TO CART</h3>

            </div >
            <div className='flex w-full bg-orange-600 h-15 items-center justify-center gap-3 rounded-md text-white cursor-pointer '>
