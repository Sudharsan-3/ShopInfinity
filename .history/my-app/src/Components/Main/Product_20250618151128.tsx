        ...
        >
          ...
          <div>
           ...
           <div className='flex gap-2 mt-2'>
            <div className='flex w-full bg-orange-400 h-20 items-center justify-center gap-3 text-white cursor-pointer'>
            <IoCartOutline />
        <h3>ADD TO CART</h3>

            </div >
            <div className='flex w-full bg-orange-600 h-20 items-center justify-center text-white cursor-pointer '>
