  ...
  return (
    <div className='flex items-center justify-center mt-4'>
        ...
        {filterByid.length>0?filterByid.map((item)=>(
          <div className='grid sm:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 w-350 h-auto bg-gray-50 p-2 rounded-md hover:shadow duration-300 hover:scale-102  ' key={item.id}>
